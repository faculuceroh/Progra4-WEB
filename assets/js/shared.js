...
(function () {
  ...
  const NAV_PAGES = [
    ...
    { key: 'trabajos',  label: 'Nuestros Trabajos', href: 'trabajos.html' },
            ...
            <div class="footer__col">
              ...
              <ul class="footer__contact-list">
                <li>
                  ...
                  Av. Constitución 1234, Buenos Aires
                </li>
                <li>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
                       stroke="currentColor" stroke-width="2" aria-hidden="true">
                ...
                <li>
                  ...
                  <span class="js-email" data-u="info" data-d="salbo" data-t="com.ar">
                    <noscript>info [arroba] salbo.com.ar</noscript>
                  </span>
                </li>
                <li>
                  <svg width="15" height="15" viewBox="0 0 24 24" fill="none"
